...
python -m sglang.launch_server \
        --model-path /home/ma-user/work/z84301856/models/llada2p1_w8a8c16_quant_SparseMoe_final \
...
# ------------------------------ LLaDA2.1 Flash -------------------------------------
# python -m sglang.launch_server \
#         --model-path /home/ma-user/work/z84301856/models/llada2p1_flash_quant_sparseMoe_final \
