...
另一个比较大的改动是：python/sglang/srt/server_args.py 中的 _handle_multi_item_scoring()。我之前parallel_zxx中的_handle_piecewise_cuda_graph()这个func完全删除了。然后_handle_a2a_moe(self)也改动很大，我也注释了。
